...
```sh
curl -fsSL https://github.com/mohseenrm/zj-agent-mob/releases/download/v0.10.1/init.sh | sh
```
...
```sh
curl -fsSL -O https://github.com/mohseenrm/zj-agent-mob/releases/download/v0.10.1/init.sh
